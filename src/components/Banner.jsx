...
function Banner() {
  return (
    <section className="relative flex justify-between items-center pt-[17px] pr-[70px] p-[11px] w-full h-[120px] bg-no-repeat bg-cover bg-[url('assets/banner.png')] ">
      <div className="flex items-center text-white font-montserrat font-bold text-sm">
        <div className="flex gap-2 justify-center items-center w-[230px]">
